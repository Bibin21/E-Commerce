...
if (isset($_POST['login'])) {
    ...
    if ($row > 0) {
        ...
        if ($resultstring[0] == md5($pass)) {
            ...
            if ($resultstring1=="b") {
                echo '<script>alert("Login Success");window.open("home.php","_self")</script';
            } else {
                echo '<script>alert("This is a seller account Redirecting to seller Login");window.open("/web dev/seller/login.php","_self")</script>';
